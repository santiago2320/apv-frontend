...
const EditarPerfil = () => {
    ...
    // Validamos los campos nombre y email.
    const handleSubmit = async e => {
        ...
        if([nombre,email].includes('')){
            ...
            // Pasa la validacion enviamos el perfil completo
            const resultado = await actualizarPerfil(perfil)

            //Mostrar alerta almanecado correctamente
            setAlerta(resultado);
    ...
    // Extraer el mensaje y asignarlo useState
    const {msg} = alerta
